categories = [
    ...
    { id: 2, order: 99, slug: 'culture', label: 'Culture', show_featured_on_home:true },
    ...
    { id: 12, order: 7, slug: 'oneroadonebelt', label: 'One Road One Belt', class: 'home-block-reverse', navbar: true, show_featured_on_home:true },
